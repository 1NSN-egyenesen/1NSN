...
#wget -O qbittorrent.exe --no-check-certificate https://sourceforge.net/projects/qbittorrent/files/qbittorrent-win32/qbittorrent-4.6.5/qbittorrent_4.6.5_x64_setup.exe/download
qbittorrent.exe

#wget -O transmission.exe --no-check-certificate https://github.com/transmission/transmission/releases/download/4.0.6/transmission-4.0.6-qt5-x64.msi
transmission.msi /quiet
